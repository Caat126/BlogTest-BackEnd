            ...
            <div class="row justify-content-center">
                ...
                <div class="row justify-content-center">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="titulo" class="form-control"
                                        placeholder="Escriba el titulo" value="{{ $post->titulo }}">
                                    @error('titulo')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                        ...
                        <div class="card m-1">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <textarea name="contenido" id="contenido" cols="30" rows="20" class="form-control">{{$post->contenido}}</textarea>
                                    @error('contenido')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                    ...
                    <div class="text-center mt-3">
                        ...
                        <a href="{{ url('posts') }}" class="btn btn-primary shadow ">Volver al listado</a>
                    </div>
