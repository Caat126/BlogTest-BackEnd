...
class PostsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($post -> save()) {
            return redirect('/posts')->with('success', 'Post creado con éxito');
        } else {
    ...
    public function update(Request $request, $id)
    {
        ...
        $post->usuario_id = auth()->user()-> id;
        if ($post -> save()) {
            return redirect('/posts')->with('success', 'Post actualizado con éxito');
        } else {
    ...
    public function estado($id)
    {
        ...
        if ($post -> save()) {
            return redirect('/posts')->with('success', 'Estado actualizada con éxito');
        } else {
