...
class CategoriasController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($categoria -> save()) {
            return redirect('/categorias')->with('success', 'Categoría creada con éxito');
        } else {
            return back()->with('error', 'No se pudo crear la categoría');
        }
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->file('imagen')) {
            ...
            $sudido = $imagen->move(public_path().'/imagenes/categorias', $nombreImagen);
            $categoria -> imagen = $nombreImagen;
        }
        ...
        $categoria -> usuario_id = auth() -> user() -> id;
        if ($categoria -> save()) {
            return redirect('/categorias')->with('success', 'Categoría actualizada con éxito');
        } else {
    ...
    public function estado($id)
    {
        ...
        if ($categoria -> save()) {
            return redirect('/categorias')->with('success', 'Estado actualizada con éxito');
        } else {
